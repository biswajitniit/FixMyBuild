(function ($) {
    ...
    $(".categories_title").click(function(e){
        $(".categories_menu_toggle").toggle();
        $(this).toggleClass('active');
         e.stopPropagation();
    });
    
    $(".categories_menu_toggle").click(function(e){
        e.stopPropagation();
    });
   ...
   /*---Newsletter Popup activation---*/
    ...
    $(document).ready(function(){
        $(".course-faq .card:eq(0)").addClass("selected");
        $(".course-faq .btn-link").click(function(){
            $(".course-faq .card").removeClass("selected"); 
    ...
    $("#open-edit").click(function(){
        $("#details-account").hide(); 
        $("#edit-account").show();
    });
    $("#close-edit").click(function(){
        $("#details-account").show(); 
        $("#edit-account").hide();
    });
    });
