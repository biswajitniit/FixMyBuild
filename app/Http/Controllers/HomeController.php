                             ...
                             <tbody>
                                ...
                                <tr>
                                   <td style="text-align: center;background: #FFF;padding:20px 30px;border-radius: 10px;">
                                      ...
                                      <h4><a href='.route('user.verify', $token).' style="color: #FFF;text-align: center;background: #EE5719;padding: 15px 50px;border-radius: 50px;margin: 10px auto;text-decoration: none;display: inline-block;">
                                            Verify Email
                                         </a>
                                      </h4>
                                ...
                                <tr>
                                   <td style="text-align:center">
                                      <p>Copyright &copy 2023 FixMyBuild. All Rights Reserved.</p>
    ...
    public function verifyAccount($token)
    {
        ...
        if(!is_null($verifyUser) ){
            ...
            if(!$user->is_email_verified) {
                ...
                $postdata = array(
                                'From'          => 'support@fixmybuild.com',
                                'To'            => 'biswajitmaityniit@gmail.com',
                                'Subject'       => 'Fixmybuild',
                                'HtmlBody'      =>  $html,
                                'MessageStream' => 'outbound'
                            );
