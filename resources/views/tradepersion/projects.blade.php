                          ...
                          <tbody>
                            ...
                            @forelse ($estimate_projects as $key=>$estimate_proj)
                                <tr>
                                    ...
                                    @if ($estimate_proj->project->status == 'project_started')
                                        <td class="text-success">Project started</td>
                                    @elseif ($estimate_proj->project_awarded == 1)
                                        <td class="text-awaiting">Estimate accepted</td>
                                    @elseif ($estimate_proj->project_awarded == 0)
                                        <td class="estimate-submitted">Estimate submitted</td>
                                    @endif
                                    <td>
                      ...
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            @foreach ($estimate_projects as $key=>$estimate_proj)
                                {{-- @if(strtolower($estimate_proj->project->status) == ) --}}
                                {{-- <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td>{{ $estimate_proj->project->project_name }}</td>
                                    <td>
