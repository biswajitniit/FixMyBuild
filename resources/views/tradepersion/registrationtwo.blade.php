                   ...
                   <div class="row">
                      ...
                      <div class="col-md-5 mb-4">
                         ...
                         <div class="row mt-3">
                            ...
                            <img src="{{ $temp_company_logo ? $temp_company_logo->url: '' }}" alt="" id="uploaded_company_logo">
                         ...
                         <div class="row mt-3">
                           <div class="col-md-4">
                            ...
                            <div class="col-md-12 mt-3" id="uploaded_pli">
                                <div class="d-inline mr-3">{{ $temp_pli ? $temp_pli->filename : '' }}</div>
                   ...
                   <div class="row">
                      ...
                      <div class="col-md-12">
                         <div class="row form_wrap mt-3">
                            ...
                            <div class="col-md-4">
                               <div class="form-group">
                                  <input type="text" name="phone_office" class="form-control" id="" placeholder="Office number" value="{{ old('phone_office') }}">
                               </div>
                            </div>
                            <div class="col-md-4">
                               <div class="form-group">
                   ...
                   <div class="col-md-12 mt-4">
                      ...
                      <div class="row mt-4">
                         ...
                         <div class="col-md-12 mt-3" id="uploaded_trader_img">
                            <div class="d-inline mr-3">{{ $temp_trader_img ? $temp_trader_img->filename : '' }}</div>
                        </div>
                      </div>
                   </div>
                </div>
                   ...
                   <div class="col-md-12">
                      ...
                      <div class="col-md-6 mt-3 mb-4">
                         <div class="d-inline mr-3" id="uploaded_trader_addr">
                            <div class="d-inline mr-3">{{ $temp_addr ?  $temp_addr->filename : ''}}</div>
                         </div>
                      </div>
                   </div>
                   <div class="col-md-12">
                                ...
                                @if($temp_team_imgs)
                                    @foreach ($temp_team_imgs as $temp_team_img)
                                        <div class="d-inline mr-3">
                                            <a href="#"><img src="{{ $temp_team_img->url }}" alt=""> </a>
                                        </div>
                                    @endforeach
                                @endif
                            </div>
                            ...
                            <div class="mt-3 mb-4" id="uploaded_prev_proj">
                                @if($temp_prev_projs)
                                    @foreach ($temp_prev_projs as $temp_prev_proj)
                                        <div class="d-inline mr-3">
                                            <a href="#"><img src="{{ $temp_prev_proj->url }}" /></a>
                                        </div>
                                    @endforeach
                                @endif
                            </div>
