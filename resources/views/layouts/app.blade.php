...
<html class="no-js" lang="en">
   ...
   @endif
                     ...
                     <div class="middel_right justify-content-end">
                        <div class="middel_right_info">
                           <div class="header_wishlist">
                            ...
                            @else
                              <div class="dropdown">
                                <a href="#" @if($unread_notifications > 0) onclick="toggleDropdown($(this))" @endif class="alert" id="dropdown">
                                    <svg width="27" height="29" viewBox="0 0 27 29" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    // function toggleDropdown(el) {
    //     var dropdownBlock = el.siblings('.dropdown-block').first();
    //     dropdownBlock.toggleClass('display-block');

    //     // Close dropdown when clicking/tapping outside
    //     $(document).on('click', function(event) {
    //         if (!dropdownBlock.is(event.target) && dropdownBlock.has(event.target).length === 0) {
    //         dropdownBlock.removeClass('display-block');
    //         }
    //     });
    // }
