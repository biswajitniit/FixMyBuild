               ...
               <div>
                  ...
                  <form action="#" method="post">
                     <div class="row">
                        <div class="form-group  col-md-12 mt-5">
                           <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="John.abc@gmail.com">
                        </div>
                     </div>
                     <div class="row">
                  ...
                  <div class="row">
                    <div class="form-group col-md-12 mt-5 text-center sign_with">
                       <p>Or sign in with</p>
                       <ul>
                        <li><a href="{{ route('login') }}"><i class="fa fa-google"></i></a></li>
