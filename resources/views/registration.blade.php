...
<body>
            ...
            <div class="row">
              <div class="form-group col-md-12 mt-5 text-center sign_with">
                ...
                <ul>
                    ...
                    <li><a href="javascript:void(0)" id="google-auth-btn"><i class="fa fa-google"></i></a></li>
                    <li>
                      <a href="javascript:void(0)" id="microsoft-auth-btn">
  ...
  <script>
    ...
    $(document).ready(function(){
        ...
        $("#microsoft-auth-btn").click(function(e) {
            e.preventDefault();
            ...
            if (phoneValid && customerOrTradespersonValid && terms_and_condition) {
                ...
                var queryString = $.param(queryParams);
                var redirectUrl = "{{ route('microsoft-auth') }}?" + queryString;
                window.location.href = redirectUrl;
            }
