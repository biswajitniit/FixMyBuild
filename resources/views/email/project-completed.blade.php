                            ...
                            <tbody>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; text-align: center;">
                                            <tbody>
                                                ...
                                                <tr style="height: 40px;">
                                                    <td><img src="{{ asset('frontend/emailtemplateimage/complete.svg') }}" alt=""></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <h2 style="font-size: 32px;">Project completed</h2>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <tr>
                                    <td style="text-align: center; background: #fff; padding: 20px 30px; border-radius: 10px;">
                                        <h5 style="color: #6d717a; font-size: 20px; font-weight: 100; line-height: 23px;">Your project titled "{{ ucwords($data['project_name']) }}" has been marked as completed by your tradesperson.</h5>
                                        <h5 style="color: #6d717a; font-size: 20px; font-weight: 100; line-height: 23px;">If there is a payment due please make the payment through our website.</h5>
