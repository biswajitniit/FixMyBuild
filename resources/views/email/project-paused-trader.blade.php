                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; padding: 10px;">
                            <tbody>
                                ...
                                <tr style='height: 70px;'>
                                    <td><h5>If you would like to unsubscribe from this notification please amend your settings <a href="{{ route('tradepersion.settings') }}" style='color:#EE5719;'>here.</a><h5></td>
                                </tr>
                                <tr>
