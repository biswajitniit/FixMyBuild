                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; text-align: center;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h2 style="font-size: 32px;">Email verification</h2>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <tr>
                                    <td style="text-align: center; background: #fff; padding: 20px 30px; border-radius: 10px;">
                                        <h5 style="color: #6d717a; font-size: 20px; line-height: 23px;">
                                            Please confirm that you have opened an account with us by clicking on the link below.
                                            If you have not opened an account you can safely ignore this email.
                                            </h5>
                                        <h4>
