                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; text-align: center;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h2 style="font-size: 32px;">New Message</h2>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <tr>
                                    <td style="text-align: center; background: #fff; padding: 20px 30px; border-radius: 10px;">
                                        @if(Auth::user()->customer_or_tradesperson == 'Tradesperson')
                                            <h5 style="color: #6d717a; font-size: 20px; font-weight: 100; line-height: 23px;">You have received a new message from "{{ ucwords($data['customer_name']) }}"</h5>
                                        @else
                                            <h5 style="color: #6d717a; font-size: 20px; font-weight: 100; line-height: 23px;">You have received a new message from "{{ ucwords($data['trader_name']) }}"</h5>
                                        @endif
                                        <h5 style="color: #6d717a; font-size: 20px; font-weight: 100; line-height: 23px;">To view your message please log into your account on our <a href="www.fixmybuild.com" style="color: #EE5719;">website</a>.</h5>
