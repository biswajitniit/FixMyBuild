...
<html class="no-js" lang="en">
   <head>
      ...
      <script src="<?php echo e(asset('frontend/js/vendor/modernizr-3.7.1.min.js')); ?>"></script>
      <!--for sweetalert-->
   ...
   <body class="inner_body">
                     ...
                     <div class="middel_right justify-content-start">
                        <div class="middel_right_info">
                           ...
                           <div class="header_sign_up d-md-block d-lg-none">
                              ...
                              <?php else: ?>
                                    <a href="<?php echo e(route('user.registration')); ?>">Register</a>
                              <?php endif; ?>
                           </div>
                        </div>
                     </div>
      ...
      <?php echo $__env->yieldContent('content'); ?>
        ...
        ============================================ -->
        <!--jquery min js-->
        <script src="<?php echo e(asset('frontend/js/vendor/jquery-3.4.1.min.js')); ?>"></script>
        <!--popper min js-->
        ...
        <!-- Video JS -->
        <script src="<?php echo e(asset('frontend/webcamjs/video.js')); ?>"></script>\
         <script src="https://cdn.tiny.cloud/1/no-api-key/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>

        <script src="https://cdn.tutorialjinni.com/intl-tel-input/17.0.8/js/intlTelInput.min.js"></script>
        <script src="<?php echo e(asset('frontend/webcamjs/video.js')); ?>"></script>
        <script src="<?php echo e(asset('frontend/webcamjs/webcam.min.js')); ?>"></script>
        <!-- Main JS -->
        <script src="<?php echo e(asset('frontend/js/main.js')); ?>"></script>
        <script>
            tinymce.init({
