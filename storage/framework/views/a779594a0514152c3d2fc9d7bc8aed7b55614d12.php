...
<script language="JavaScript">
    ...
    function FetchfilesData(){
        $.ajax({
            type:'POST',
            url:'<?php echo e(route("customer.getcustomermediafiles")); ?>',
    ...
    function deletetempmediafile(deleteid){
        ...
        if (result==true) {
            $.ajax({
                type:'POST',
                url:'<?php echo e(route("customer.deletecustomermediafiles")); ?>',
        ...
        $("form#capturephoto").submit(function(e){
            ...
            confirmButtonText: 'Yes'
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<?php echo e(route("capture-photo")); ?>',
                        type: 'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\webdev\FixMyBuild\resources\views/customer/newproject.blade.php ENDPATH**/ ?>