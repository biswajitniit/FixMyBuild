         ...
         <section  class="auth-sidebar">
            <div class="auth-sidebar-content p-4">
               <div id="particles-js">
                  ...
                  <div class="artwork">
                     <img src="<?php echo e(asset('frontend/img/log-reg-img.png')); ?>"  alt="">
                     <h2>Welcome Back</h2>
               ...
               <div>
                  <div class='row'>
                     <div class='input-field col-md-12'>
                        ...
                        <p  class="heading2">
                           Not a member?
                           <span><a class="link-color" href="<?php echo e(url('user/registration')); ?>">Register Now</a></span>
                         </p>
                     </div>
                  </div>
                  ...
                  <form action="<?php echo e(route('user.loginpost')); ?>" method="post" name="login">
                    <?php echo csrf_field(); ?>
                     <div class="row">
