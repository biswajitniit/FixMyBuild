                            ...
                            <div class="tab-pane text-style <?php if($i==1): ?> active <?php endif; ?>" id="tab<?php echo e($i); ?>">
                               <div class="wrap">
                                  <div class="search">
                                     ...
                                     <input type="text" class="searchTerm" placeholder="Search your address">
                                  </div>
                               </div>
                               <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\webdev\FixMyBuild\resources\views/tradepersion/registrationtwo.blade.php ENDPATH**/ ?>