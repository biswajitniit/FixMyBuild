...
<section class="pb-5">
    <div class="container">
        <form action="<?php echo e(route('customer.storeproject')); ?>" method="post" name="savenewproject" id="savenewproject">
            <?php echo csrf_field(); ?>
            <div class="row">
                ...
                <div class="col-md-10 offset-md-1">
                    <div class="white_bg mb-5">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <a href="<?php echo e(route('dropzoneupload')); ?>" data-bs-toggle="modal" onclick="geturldata(event)" class="btn btn-outline-danger btn-block">
                            ...
                            <div class="col-md-6 mt-2">
                                <div class="d-inline mr-3">
                                    abc.doc (3MB) <a href="#"><img src="<?php echo e(asset('frontend/img/crose-btn.svg')); ?>" alt="" /> </a>
                                </div>
                                <div class="d-inline mr-3">
                                    xyz.jpg (6MB) <a href="#"><img src="<?php echo e(asset('frontend/img/crose-btn.svg')); ?>" alt="" /> </a>
                                </div>
                            </div>
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        $.each(data.addresses, function(index, value) {
                            addresshtml += '<div class="form-check target"><input type="radio" class="form-check-input" id="radio1" name="optradio" value="'+value+'"  />'+value+'<label class="form-check-label" for="radio1"></label></div>';
                        });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\FixMyBuild\resources\views/customer/newproject.blade.php ENDPATH**/ ?>