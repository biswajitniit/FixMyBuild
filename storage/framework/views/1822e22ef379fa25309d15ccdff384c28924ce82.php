    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="category">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('buildercategory.index')); ?>">Category</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('buildersubcategory.index')); ?>">Sub Category</a></li>
                        </ul>
                    </div>
                </li>
          ...
          <?php if(Auth::guard('admin')->user()->type == "reviewer"): ?>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(url('admin/project/awaiting-your-review')); ?>">
                  <i class="mdi mdi-view-dashboard menu-icon"></i>
...
<?php /**PATH E:\webdev\FixMyBuild\resources\views/layouts/admin.blade.php ENDPATH**/ ?>