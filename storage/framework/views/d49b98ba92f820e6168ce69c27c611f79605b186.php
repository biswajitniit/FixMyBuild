         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-6 col-sm-12 text-center order-1 order-xl-2 order-lg-2 order-md-2 order-sm-1">
                  <div class="img">
                     <img src="<?php echo e(asset('frontend/img/banner-img.png')); ?>" alt="" class="img-fluid">
                  </div>
               </div>
            </div>
         </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\FixMyBuild\resources\views/welcome.blade.php ENDPATH**/ ?>