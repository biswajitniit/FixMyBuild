...
<section>
 ...
 <section class="pb-5">
    <div class="container">
      ...
      <?php endif; ?>
       <form action="<?php echo e(route('tradepersion.savebankregistration')); ?>" method="post">
        <?php echo csrf_field(); ?>
          <div class="row">
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="alert alert-success" role="alert">
                        ...
                        <hr>
                        <p class="mb-5">Your registration will be reviewd and our team will contact you if we need more information.</p>
                        <p><a href="<?php echo e(route('home')); ?>" class="btn btn-primary">Submit</a></p>
                     </div>
                  </div>
               </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\FixMyBuild\resources\views/tradepersion/registrationthree.blade.php ENDPATH**/ ?>