    ...
    <div class="content-wrapper">
      <div class="page-header flex-wrap">
        ...
        <div class="header-right d-flex flex-wrap mt-2 mt-sm-0">
          ...
          <button type="button" onclick="location.href='<?php echo e(route('buildersubcategory.create')); ?>'" class="btn btn-primary mt-2 mt-sm-0 btn-icon-text">
        ...
        // DataTable
            $('#my-table').DataTable({
                ...
                "ajax": {
                    ...
                    url : "<?php echo e(route('getbuildersubcategory')); ?>",
                    type : 'GET',
                },
                columns: [
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\webdev\FixMyBuild\resources\views/admin/builder/subcategory/sub-category-list.blade.php ENDPATH**/ ?>