    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 dashboard_sidebar">
                <ul>
                    <li class="active"><a href="<?php echo e(route('customer.profile')); ?>">Profile</a></li>
                    <li><a href="<?php echo e(route('customer.project')); ?>">Projects</a></li>
            ...
            <div class="col-md-9 dashboard_wrapper">
                <div class="blue-font-color mt-4 mb-5">
                    <div class="row">
                        <div class="col-md-3 profile_pics">
                            <img src="<?php echo e(asset('frontend/img/Rectangle 88.png')); ?>" alt="" />
                            <a href="#" data-bs-toggle="modal" data-bs-target="#profile_pics"><img src="<?php echo e(asset('frontend/img/edit-pics.svg')); ?>" alt="" class="edit-pics" /></a>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 supported_">
                                                    ...
                                                    <div class="text-center upload_wrap cpp_wrap">
                                                        <img src="<?php echo e(asset('frontend/img/upload.svg')); ?>" alt="" />
                        ...
                        <div class="col-md-9">
                            <h3>
                                ...
                                <span>
                                    <a href="#"><img src="<?php echo e(asset('frontend/img/edit-pencil.svg')); ?>" alt="" /></a>
                                </span>
                            </h3>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <h5>
                                        Password: ************* <a href="#" data-bs-toggle="modal" data-bs-target="#change_pw"><img src="<?php echo e(asset('frontend/img/edit-pencil.svg')); ?>" alt="" /></a>
                                    </h5>
                                </div>
                ...
                <div class="white_bg">
                    <div class="row num_change">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="phone" placeholder="20 7278 3339" value="<?php echo e(Auth::user()->phone); ?>"/>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\FixMyBuild\resources\views/customer/profile.blade.php ENDPATH**/ ?>