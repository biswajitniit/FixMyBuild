              ...
              <form class="cmxform" id="save_awaiting_review" method="post" action="<?php echo e(route('awaiting-your-review-save')); ?>" name="save_awaiting_review">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <?php if($project->reviewer_status == ''): ?>
                            <div class="row">
                        ...
                        <?php if($project->reviewer_status == 'Refer'): ?>
                            <div class="row">
                                <table class="table-hover" id="customFields" style="width:100%">
                                    <tbody id="TextBoxesGroup">
                                        <tr valign="top">
                                           ...
                                           <?php if($projectnotesandcommend): ?>
                                                <?php $__currentLoopData = $projectnotesandcommend; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projectrow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <td>
                                                        <select name="notes_for[]" id="notes_for1" class="form-select">
                                                            <option value="internal" <?php if($projectrow->notes_for == 'internal' ): ?>selected <?php endif; ?>>Internal</option>
                                                            <option value="customer" <?php if($projectrow->notes_for == 'customer' ): ?>selected <?php endif; ?>>To Customer</option>
                                                            <option value="tradespeople" <?php if($projectrow->notes_for == 'tradespeople' ): ?>selected <?php endif; ?>>For Tradespeople</option>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <textarea name="description[]" id="description1" class="form-control" style="height: 20px"><?php echo e($projectrow->notes); ?></textarea>
                                                    </td>
                                                    <td></td>
                                                    <?php
                                                    $count++;
                                    ...
                                    <input type="hidden" id="count_total_record_id" value="<?php echo e($count); ?>" />
                                </table>
                                <!-- end col -->
                            </div>
                        <?php endif; ?>
